...
#   ifdef SIXTEEN_TWENTYFOUR
        num_keys = 1; // ! How do i calculate num keys? Hard coded for now
        n = 24;
        t = 16;
        num_seats = 20; // ! Wrong, how do i calculate? n/t-1 doesnt make sense
        key_idx = 0;
...
#   else
        ...
        omega_col_idxs = (int*)calloc(n, sizeof(int));
        key_ids = (int*)calloc(num_keys, sizeof(int));
        omega_matrix = (int*)calloc(n*num_seats, sizeof(int)); // n x num_seats key_idsay
#   endif
...
/*
 * Populates key ids into the key_idsay.
...
#   ifdef SIXTEEN_TWENTYFOUR
        // TODO
#   else
        // populate the key_ids[] with id's 1-10
